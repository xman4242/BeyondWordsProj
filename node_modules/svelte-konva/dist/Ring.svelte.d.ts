...
declare const __propDef: {
    props: {
        config: Konva.RingConfig;
        handle?: import("konva/lib/shapes/Ring").Ring | undefined;
 ...
 */
export default class Ring extends SvelteComponentTyped<RingProps, RingEvents, RingSlots> {
}
export {};
