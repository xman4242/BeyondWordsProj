...
declare const __propDef: {
    props: {
        config: Konva.TextPathConfig;
        handle?: import("konva/lib/shapes/TextPath").TextPath | undefined;
        staticConfig?: boolean | undefined;
    };
    slots: {};
    events: KonvaEvents;
};
export type TextPathProps = typeof __propDef.props;
export type TextPathEvents = typeof __propDef.events;
export type TextPathSlots = typeof __propDef.slots;
/**
 ...
 */
export default class TextPath extends SvelteComponentTyped<TextPathProps, TextPathEvents, TextPathSlots> {
}
export {};
