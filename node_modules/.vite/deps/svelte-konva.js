  ...
  "node_modules/konva/lib/Node.js"(exports) {
    ...
    var Node = class _Node {
      ...
      static _createNode(obj, container) {
        var className = _Node.prototype.getClassName.call(obj), children2 = obj.children, no, len, n;
        if (container) {
        ...
        if (children2) {
          len = children2.length;
          for (n = 0; n < len; n++) {
            no.add(_Node._createNode(children2[n]));
          }
        }
        return no;
      }
...
var require_Arc = __commonJS({
  "node_modules/konva/lib/shapes/Arc.js"(exports) {
    ...
    Arc2.prototype._attrsAffectingSize = ["innerRadius", "outerRadius"];
...
var require_TextPath = __commonJS({
  "node_modules/konva/lib/shapes/TextPath.js"(exports) {
    ...
    Factory_1.Factory.addGetterSetter(TextPath2, "textDecoration", null);
    Factory_1.Factory.addGetterSetter(TextPath2, "kerningFunc", null);
  }
});
